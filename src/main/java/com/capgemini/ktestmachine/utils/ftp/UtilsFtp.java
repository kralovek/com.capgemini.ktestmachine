...
public class UtilsFtp {
	...
	private static final class CopyStreamListenerImpl implements
			CopyStreamListener {
	...
	public static FTPClient connect(String host, int port, String login, String password) throws ABaseException {
