...
public class FileManagerFtpApacheCommons extends AFileManagerFtpApacheCommonsFwk implements FileManager {
	private static final Logger LOGGER = Logger.getLogger(FileManagerFtpApacheCommons.class);
	...
	private void contentToFile(String content, String filename,
			String encoding, String dir, boolean gz) throws ABaseException {
		LOGGER.trace("BEGIN");
		try {
			testConfigured();
