...
import com.capgemini.ktestmachine.component.templateparser.impl.content.*;
import com.capgemini.ktestmachine.component.templateparser.impl.parts.*;
import com.capgemini.ktestmachine.component.templateparser.impl.tags.Attribute;
import com.capgemini.ktestmachine.component.templateparser.impl.tags.Tag;
import com.capgemini.ktestmachine.exception.ABaseException;

public class TemplateParserImpl extends ATemplateParserImplFwk implements
		TemplateParser {
	...
	private int[] evaluateIndexes(Map<String, Integer> indexes,
			String[] indexNames) throws ABaseException {
	...
	private String evaluateParameter(String name, int[] indexes,
			final Map<String, Object> parameters) throws ABaseException {
	...
	private Content createContent(List<Part> pParts,
			Map<String, Object> pParameters) throws ABaseException {
	...
	private Part createPart(Tag pTag) throws ABaseException {
	...
	private String contentToString(Content pContent) throws ABaseException {
	...
	private List<Object> createTags(String source) throws ABaseException {
