...
import com.capgemini.ktestmachine.component.cleanmanager.CleanManager.Group;
...
public class RunnerClean extends ARunnerCleanFwk implements Runner {
	private static final Logger LOGGER = Logger.getLogger(RunnerClean.class);
	...
	public Map<String, Object> run(Map<String, Object> parameters)
		...
		try {
			...
			if (cleanManagers.isEmpty()) {
				LOGGER.warn("No clean manager is defined");
				LOGGER.trace("OK");
				return results;
			}
	...
	private List<CleanDetail> prepareCleanCalls(Map<String, Object> parameters) throws ABaseException {
	...
	private String[] getCleanGroupFromParameter(String parameter) throws ABaseException {
