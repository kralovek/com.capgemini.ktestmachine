...
public class DiffManagerDatabase extends ADiffManagerDatabaseFwk implements
	...
	public List<Group> loadCurrents() throws ABaseException {
		...
		try {
			...
			try {
				...
				// Date dateCurrentTimestamp = loadCurrentTimestamp(connection);
	...
	private int determineSortType(Connection connection, String table,
			String column) throws ABaseException {
		LOGGER.trace("BEGIN");
		try {
