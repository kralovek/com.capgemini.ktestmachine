...
public class XStreamParser {
    ...
    public InputParameters parseInputParameters(final String pSource) throws ABaseException {
    ...
    private Object loadInputObject(final String pSource) throws ABaseException {
        XStream xstream = new XStream(new DomDriver());
