...
public class MainKTestMachineSynthese {
	private static final Logger LOGGER = Logger
			.getLogger(MainKTestMachineSynthese.class);

	private static final String ID_BEAN = "kTestSynthese";

	public static void main(final String[] pArgs) {
		final MainKTestMachineSynthese mainKTestMachineSynthese = new MainKTestMachineSynthese();
